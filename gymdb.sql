...
CREATE TABLE `attendance` (
  ...
  `AttendanceId` varchar(45) NOT NULL,
  ...
  CONSTRAINT `FullName` FOREIGN KEY (`FullName`) REFERENCES `clients` (`FullName`)
...
CREATE TABLE `clients` (
  ...
  `DateTimeCreated` varchar(45) DEFAULT 'CURRENT_TIMESTAMP',
  `DateTimeUpdated` varchar(45) DEFAULT 'CURRENT_TIMESTAMP',
...
-- Dump completed on 2022-03-19  0:02:47
